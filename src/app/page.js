  ...
  <div className="pb-8 text-center">
    ...
    <div className="lg:flex gap-10">
      <div className="text-center shadow-lg p-10 rounded-xl my-10">
        ...
        <div className=" py-1">
          <p className="text-teal-600">VmWare:</p> Har brugt VmWare på Grundforløbet.
        </div>
        <div className=" py-1">
          <p className="text-teal-600">Visual Code:</p> Har brugt det i undervisningen og bruger det i mange af mine projekter.
        </div>
        <div className=" py-1">
          <p className="text-teal-600">NetBeans:</p> Har brugt det til mine PHP-projekter.
        </div>
        <div className=" py-1">
      ...
      <div className="text-center shadow-lg p-10 rounded-xl my-10">
        ...
        <p className=" py-1">
          <p className="text-teal-600">Engelsk:</p> Kan skrive og kommunikere med andre.
        </p>
        <p className=" py-1">
          <p className="text-teal-600">Dansk:</p> Snakker flydende Dansk. kan skrive og kommunikere med andre.
        </p>
        <p className=" py-1">
          <p className="text-teal-600">Skandinavisk:</p> Kan forstå noget svensk
        </p>
      </div>
      <div className="text-center shadow-lg p-10 rounded-xl my-10">
        <Image
        ...
        <p className=" py-1">
          <p className="text-teal-600">Film & Serier</p>Kan godt lide at se krimi, gyser, komedie film & serier
        </p>
        <p className=" py-1">
          <p className="text-teal-600">Musik</p>Elsker at lytte til musik som fx The Beatles.
        </p>
      </div>
    </div>
    <h3 className="text-3xl py-1 pb-6">Projekter</h3>
    <div className="lg:flex justify-center gap-10"> {/* Modified */}
      <div className="text-center shadow-lg p-10 rounded-xl my-10">
        <Image
          src={chat}
          alt="chat"
        ...
        <p className="py-1">
          Udviklet en ny databasestruktur for KaosTek, herunder design, oprettelse og SQL-query til rapportgenerering af kundeordrer.
        </p>
      </div>
      <div className="text-center shadow-lg p-10 rounded-xl my-10">
        <Image
